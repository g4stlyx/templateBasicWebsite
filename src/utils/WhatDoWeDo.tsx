          ...
          <Row className="mb-4">
            <Col>
              <Card
                ...
                className={`text-center p-3 ${activeComponent === 'CustomStretcher' ? 'bg-primary text-white' : ''}`}
              >
                <Card.Img variant="top" src="https://pokedexradio.com/wp-content/uploads/2014/01/242-Blissey.png" width="60px" height="75px" />
                <Card.Body>
            ...
            <Col>
              <Card
                ...
                className={`text-center p-3 ${activeComponent === 'HospitalBeds' ? 'bg-primary text-white' : ''}`}
              >
                <Card.Img variant="top" src="https://pokedexradio.com/wp-content/uploads/2014/01/242-Blissey.png" width="60px" height="75px" />
                <Card.Body>
                  <Card.Title>Hasta Yatakları İmalatı</Card.Title>
                </Card.Body>
              </Card>
            </Col>
            <Col>
              <Card
                ...
                className={`text-center p-3 ${activeComponent === 'AmbulanceStretchers' ? 'bg-primary text-white' : ''}`}
              >
                <Card.Img variant="top" src="https://pokedexradio.com/wp-content/uploads/2014/01/242-Blissey.png" width="60px" height="75px" />
                <Card.Body>
            ...
            <Col>
              <Card
                ...
                className={`text-center p-3 ${activeComponent === 'MassageTables' ? 'bg-primary text-white' : ''}`}
              >
                <Card.Img variant="top" src="https://pokedexradio.com/wp-content/uploads/2014/01/242-Blissey.png" width="60px" height="75px" />
                <Card.Body>
            ...
            <Col>
              <Card
                ...
                className={`text-center p-3 ${activeComponent === 'HealthCabinInstallation' ? 'bg-primary text-white' : ''}`}
              >
                <Card.Img variant="top" src="https://pokedexradio.com/wp-content/uploads/2014/01/242-Blissey.png" width="60px" height="75px" />
                <Card.Body>
            ...
            <Col>
              <Card
                ...
                className={`text-center p-3 ${activeComponent === 'MedicalProductSupply' ? 'bg-primary text-white' : ''}`}
              >
                <Card.Img variant="top" src="https://pokedexradio.com/wp-content/uploads/2014/01/242-Blissey.png" width="60px" height="75px" />
                <Card.Body>
